...
| 平台 | 状态 | SDK 版本 | 说明 |
|------|------|----------|------|
| **iOS** | ✅ 已支持 | v1.2.1 | 原生 APNs 集成，生产可用 |
| **Android** | ✅ 已支持 | v1.2.1 | 多厂商推送支持，生产可用 |
| **React Native** | ✅ 已支持 | v0.5.1 | 基于 Expo Modules 的 RN/Expo 接入层，支持 APNs、FCM 与 6 类 Android OEM 通道，生产可用 |
